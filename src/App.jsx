...
<title>${escapeHtml(title)}</title>
  ...
  .fee-box {  display:flex ; justify-content:space-between ; align-items: center; border-radius: 6px; text-align: center; background: #fff; }
...
${pages.map(page => `<div class="page">${page.map(s => {
      ...
      return `
        <div class="student-block">
          <!-- School Copy -->
           <div class="receipt">
            <img src="../assest/logo.jpg" class="watermark" alt="Logo"/>
              <div class="content">
              <div class="copy-label">School Copy</div>
              <div class="header">Iqra Grammar Public School</div>
              <div class="sub-header meta"><i><b>Branch:</b> Gulshan Hameed Colony oposite wensum college D.I.Khan</i></div>
              <div class="d-flex">
                <div class="school-no">Ph: 03365716844</div>
                <div class="meta">
                  Due date • 5 ${new Date(new Date().setMonth(new Date().getMonth() + 1)).toLocaleDateString("en-US", { month: "long", year: "numeric" })}
                </div>
              </div>
              ...
              <div class="d-flex Pym-detail">
                  <div class=""><b>Payment Details</b></div>
                  <div class=""><b>Amount</b></div>
              </div>
              <div class="d-flex">
                <div class="">
                  <div class="fee-label">Monthly Fee</div>
                  <div class="fee-label">Pending (Base)</div>
                  </div>
                  <div class="">
                  <div class="">${(s.monthlyFee)}</div>
                  <div class="">${(basePending)}</div>
                </div>
              </div>
               <div class="extras">
                  <div><b></b></div>
              ...
              <b>Total Due:</b>
              <div> ${formatPrintCurrency(basePending + extrasPending)}</div>
              </div>
            </div>
          </div>
...
<body>
  <div class="dmc-container">
    <img src="../assest/logo.jpg" class="watermark" alt="School Logo"/>
    <div class="content">
      <div class="header">
...
<body>
  <div class="certificate-container">
    <img src="../assets/logo.jpg" class="watermark" alt="School Logo"/>
    ...
    <div class="content">
      ...
      <img src="../assets/logo.jpg" class="seal" alt="School Seal"/>
    </div>
  </div>
</body>
</html>
